...
RUN apt-get update
RUN apt-get install -y python-cairo libc-dev libexpat1-dev libssl-dev g++ python2.7-dev collectd-core libgcrypt11 python-virtualenv build-essential python-dev supervisor sudo
